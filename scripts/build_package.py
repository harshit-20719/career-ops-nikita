    ...
    "bansal-foundation": {
        ...
        "letters": [
            ("Cover letter", [
                ...
                "What I think matters more for a role that begins with an empty room: I have built a portfolio area from nothing before. I created the Trusts' climate-health vertical where no vertical existed — designed the thesis, built the first programmes, and secured the funding to stand it up. That is a smaller version of what you're describing, and it taught me that the hard part isn't the strategy document. It's the sequence: what has to be true before anything else can happen, and which decisions you are allowed to defer.",
        ...
        "checklist": [
            ...
            "<b>This resume version restores the climate-health vertical bullet</b> that you pulled on 11 Aug. It's back because it is the only evidence on your CV of building something from zero, and that is precisely what this role is. Take it out if you still don't want it — but read the bullet first",
